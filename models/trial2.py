...
__all__ = ['ResNet', 'trial2', 'resnet20']
...
class Trial2Block(nn.Module):
    expansion = 1

    def __init__(self, in_planes, planes, stride=1, in_size=32, out_size=32, option='A'):
        super(Trial2Block, self).__init__()
...
def trial2(num_classes):
    return ResNet(Trial2Block, [3, 3, 3], num_classes=num_classes)
